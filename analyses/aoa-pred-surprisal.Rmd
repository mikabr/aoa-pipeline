...
# Load suprisal and frequency by language

Suprisal values currently are stored separately by language and model (will combine them later) 
```{r load_model_surprisals}

load in csv for each lang and combine them into one table called surprisals
...
left_join(surprisals, concreteness)
