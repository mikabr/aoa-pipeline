...
get_childes_metrics <- function(args_, column="language", freq=FALSE, uttlength=FALSE, wordlen = FALSE, order = FALSE ){
  ...
  metrics <- full_join(mlu, worder) %>% full_join(wlength) %>% distinct()
...
output<- get_childes_metrics(args_, uttlength = TRUE, freq = FALSE, wordlen = TRUE, order = TRUE)
