...
pat <- c("jap", "cro", "man", "can", "dut", "gre", "ses", "slo", "far", "ser", "ber")
replace <- c("jpn", "hrv", "zho", "yue", "nld", "ell", "sot", "slv", "fas", "srp", "taq")
...
childes_metrics<- get_childes_metrics(lang, corpus = "Tonelli", word = "", speaker_role = NULL, speaker_role_exclude = "Target_Child", target_child ="Elisa", child_age = NULL, child_sex = NULL, uttlength = TRUE , freq = TRUE , charlen = TRUE , order = TRUE)
