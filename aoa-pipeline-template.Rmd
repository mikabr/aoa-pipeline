...
# just for testing:
target_langs <- c("French (French)", "Dutch", "English (American)", 
                  "Norwegian", "Croatian", "Turkish", "Hungarian")
```
...
walk(target_langs[4:7], get_uni_lemma_metrics, build_uni_lemma_map(uni_lemmas))
```
...
aoa_models_lexcat <- fit_models(predictors[predictors != "length_char"], aoa_predictor_data,
