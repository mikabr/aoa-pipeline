...
target_langs <- c("French (Quebecois)", "Croatian")
...
tur_token_metrics <- get_childes_metrics("French (Quebecois)", metric_funs,
                                         corpus_args)
tur_uni_lemma_metrics <- get_uni_lemma_metrics("Croatian",
                                               uni_lemma_map)
```
...
#4. log transformed smoothed frequencies (frequency, final_frequency, first_frequency, solo_frequency)
```
...
uni_joined$final_frequency <- do_residualization(final_frequency, frequency, data = uni_joined)

uni_joined$solo_frequency  <- do_residualization(solo_frequency, frequency, data = uni_joined)
```
