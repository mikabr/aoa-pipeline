...
cv_df<-function(lang, word_values, meas, lex=FALSE){
...
cv_across_lang <- map_df(unique(word_values_$language), cv_df, word_values, "produces") %>%
  rbind(map_df(unique(word_values_$language), cv_df, word_values, "understands")) #####cross-validation for each language


cv_across_lang_lex <- map_df(unique(word_values_$language), cv_df, word_values, meas="understands", lex=TRUE) %>%
  rbind(map_df(unique(word_values_$language), cv_df, word_values, "produces", lex=TRUE)) ####check lexical category distribution 
