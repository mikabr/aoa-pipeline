...
#childes_lang = "nld"
##l="nld"
#fra_childes <- get_token_metrics("Danish", metric_funs, corpus_args)#
#fra_unilemmas <- get_uni_lemma_metrics("Danish", build_uni_lemma_map(uni_lemmas|> filter(language #=="Danish")))
...
run_main_model<-function(lang, aoa_predictor_data, predictors, uni_lemmas, ref_cat){
  ...
  m<-fit_models(predictors, aoa_predictor_data_lexcat, lexcat_interactions = TRUE) |> 
...
aoa_models1 <- map_df(target_langs, run_main_model, aoa_predictor_data1, predictors1, uni_lemmas, ref_cat)
...
aoa_models_v1<- fit_models(predictors1, aoa_predictor_data1 |>filter(lexical_category =="predicates"), lexcat_interactions = FALSE )


aoa_models_v2 <- fit_models(predictors2, aoa_predictor_data2 |>filter(lexical_category =="predicates"), lexcat_interactions = FALSE )
