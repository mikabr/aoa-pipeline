...
target_langs <- c("English (American)", "Norwegian",
                  "Russian", "Turkish", "Italian",
                  "Swedish",  "French (Quebecois)", "Danish", 
                  "Croatian", "French (French)", "English (Australian)",
                  "German", "English (British)", "Spanish (European)",
                  "Spanish (Mexican)", "Portuguese (European)")

#target_langs <- c("Mandarin (Beijing)")
