...
pred_sources <- list(
  ...
  c("concreteness", "valence", "babiness"), #"babiness",
  c("mlu"),
  c("length_char"),
  c("n_tokens"))
...
################# with and without lex cat

fitted_aoa_models <- map_df(preds, fit_models, joined_data)
fitted_aoa_models

##############Check combined effect of lex cat and interaction

#########Other and babiness TODO 

###########other correctly coded TODO 
...
############## plot by lex_Category and prediction error TODO 
```
