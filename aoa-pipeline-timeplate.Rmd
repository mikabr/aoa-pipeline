...
conctreteness <- uni_lemmas %>% map_predictor("concreteness", concreteness_map)
```
...
uni_joined <- uni_lemmas %>% 
  ...
  left_join(conctreteness, by = c("language", "uni_lemma"))
```

Add CHILDES predictors

```{r}
target_langs <- c("Italian") #Italian French (French) Russian - !!! stemming from wordbank cyrillic vs stemmer latin
