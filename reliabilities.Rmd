...
target_langs <- c("French (French)", "English (American)", "Italian")#, "Italian", "Turkish"
...
predictor_list <- c("length_char", "n_type", "mlu", "freq","freq_solo", "freq_first", "freq_last", "n_sfx", "n_category",  "prefix") #"n_distinct_frame"
...
get_main_rel <-function(lang){
  ...
  r=c(pred_cor("length_char", df),pred_cor("n_type", df), pred_cor("mlu", df),  pred_cor("freq", df), pred_cor("freq_solo", df), pred_cor("freq_first", df), pred_cor("freq_last", df), pred_cor("n_sfx", df), pred_cor("n_category", df), pred_cor("prefix", df)) # pred_cor("n_distinct_frame", df),
