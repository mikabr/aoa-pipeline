...
ggplot(aoa_predictor_data, aes(x = freq, y = aoa, col=language)) + 
...
ggplot(aoa_predictor_data, aes(x = concreteness, y = aoa, col=language)) + 
...
ggplot(aoa_predictor_data, aes(x = mlu, y = aoa, col=language)) + 
...
ggplot(aoa_predictor_data, aes(x = freq_solo, y = aoa, col=language)) +  #not precise enough
...
ggplot(aoa_predictor_data, aes(x = length_char, y = aoa, col=language)) +  #not precise enough
...
plt_lang_coefs$term <- factor(plt_lang_coefs$term, levels=c("Freq", "Concreteness", "MLU-w", "Babiness", "Freq solo", "Length char", "Function words", "Predicates", "Nouns", "N sfx", "N category", "N type", "Freq first", "Freq last"))
...
#man_t_across_lang_lex_desc<- readRDS("data/plots/man_t_across_lang_lex_desc.rds" )
